...
SELECT d.department_id, d.department_name, d.manager_first_name, d.manager_last_name, p.purchase_order_id, p.total_amount
FROM departments d
...
SELECT p.patient_id, p.first_name, p.last_name, a.nursing_unit_id, a.primary_diagnosis
FROM patients p
JOIN admissions a ON p.patient_id = a.patient_id
...
SELECT p.first_name + ' ' + p.last_name 'patient', a.nursing_unit_id, a.room, m.medication_description
