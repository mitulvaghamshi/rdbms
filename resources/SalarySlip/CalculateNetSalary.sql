...
-- USE AS STAND ALONE SCRIPT - OPTIONAL
/****************************************************************
-- REMOVE {DB_NAME} DATABASE IF ALREADY EXISTS
...
-- MAKE THE {DB_NAME} THE CURRENT DATABASE
USE DB_NAME;
GO
...
-- THE SCRIPT USAGE {TSQL2012} DATABASE
USE TSQL2012;
GO
...
WHILE @COUNT <= @MAX BEGIN
	...
	DECLARE @emp_id INT; SELECT @emp_id = emp_id FROM #TempTable WHERE e_id = @COUNT;
	...
	SELECT @tax = total_tax, @cpp = cpp_deductions, @ei = ei_deductions, @salary = after_tax_salary
...
-- FOR REFERENCE ONLY, EXECUTE TO RE-CREATE {tblEmployee}  
/************************************************************************************************************************************************************************************
CREATE OR ALTER PROCEDURE dbo.SP_Create_Employee_Table 
AS
SET ANSI_NULLS ON
GO
...
INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2, N'Karry', N'KKhall@yahoo.com', NULL, N'Male', 4, 325.0000, CAST(0.21 AS Decimal(3, 2)), CAST(0.07 AS Decimal(3, 2)), CAST(0.05 AS Decimal(3, 2)), 81000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (1148, N'Sujawal', N'sujawalfff@yahoo.com', NULL, N'Female', 1, 650.0000, CAST(0.25 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), CAST(0.03 AS Decimal(3, 2)), 77000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2200, N'Allana', N'Allana@gmail.com', NULL, N'Female', 3, 280.0000, CAST(0.28 AS Decimal(3, 2)), CAST(0.05 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), 120000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2204, N'John', N'jadde@yahoo.com', NULL, N'Male', 2, 180.0000, CAST(0.28 AS Decimal(3, 2)), CAST(0.24 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), 55000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2205, N'Sally', N'salley@yahoo.com', NULL, N'Female', 3, 250.0000, CAST(0.28 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), CAST(0.05 AS Decimal(3, 2)), 58000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2207, N'Jane', N'jane@yahoo.com', NULL, N'Male', 4, 150.0000, CAST(0.05 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), 79000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2209, N'Jiggar', N'jghdd25@yahoo.com', NULL, N'Male', 3, 160.0000, CAST(0.25 AS Decimal(3, 2)), CAST(0.05 AS Decimal(3, 2)), CAST(0.04 AS Decimal(3, 2)), 78000.0000);

INSERT [dbo].[tblEmployee] ([emp_id], [emp_name], [emp_email], [emp_password], [emp_gender], [noOfDependants], [Additions], [ITex], [CPP], [EI], [GrossSalary]) 
VALUES (2212, N'Nattaly Hill ', N'natilli@yahoo.com', NULL, N'Female', 3, 180.0000, CAST(0.28 AS Decimal(3, 2)), CAST(0.05 AS Decimal(3, 2)), CAST(0.03 AS Decimal(3, 2)), 78500.0000);
